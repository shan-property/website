...
<NavLi class="py-1.25 text-center sm:text-start md:py-2" href={based_href} {active}>
	<span
		class="transition-navbar-bg-text md:afterline afterline-sm font-bold after:left-1/8 after:bg-primary sm:after:left-0 {active
